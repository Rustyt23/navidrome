// ui/src/common/SongDatagrid.jsx
...
const useStyles = makeStyles({
  ...
  headerStyle: {
    ...
    '& th': {
      fontWeight: 'bold',
      padding: '4px', // tighter header cells
    },
  },
  // ↓ Reduce the vertical gap between rows (border-spacing controls the "blank space")
  tightGap: {
    '& .MuiTable-root, & .RaDatagrid-table': {
      borderCollapse: 'separate',
      borderSpacing: '0 1px', // was larger; lower number = tighter rows
    },
  },
  contextMenu: {
    visibility: (props) => (props && props.isDesktop ? 'hidden' : 'visible'),
  },
})
...
export const SongDatagrid = ({
  ...
  return (
    <Datagrid
      className={clsx(classes.headerStyle, classes.tightGap)}
