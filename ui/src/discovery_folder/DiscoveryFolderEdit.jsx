...
const DiscoveryFolderTitle = ({ record }) => {
...
const DiscoveryFolderEdit = (props) => (
  <Edit title={<DiscoveryFolderTitle />} actions={false} {...props}>
    <DiscoveryFolderEditForm />
  </Edit>
)

export default DiscoveryFolderEdit
