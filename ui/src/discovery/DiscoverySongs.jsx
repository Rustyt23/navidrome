...
const DiscoverySongs = ({ playlistId, readOnly, actions, ...props }) => {
  ...
  const onAddToDiscovery = useCallback(
    (pls) => {
        ...
        >
          ...
          >
            ...
            >
              {columns}
              <SongContextMenu
                onAddToDiscovery={onAddToDiscovery}
                showLove={true}
...
const SanitizedDiscoverySongs = (props) => {
...
export default SanitizedDiscoverySongs
