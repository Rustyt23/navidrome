...
func setViperDefaults() {
	...
	viper.SetDefault("retailplayer.enabled", true)
	...
	viper.SetDefault("retailplayer.notifications.enabled", true)
	viper.SetDefault("retailplayer.notifications.smtpserver", "smtp.gmail.com")
	viper.SetDefault("retailplayer.notifications.smtpport", 587)
	viper.SetDefault("retailplayer.notifications.subject", "Song 👎")
