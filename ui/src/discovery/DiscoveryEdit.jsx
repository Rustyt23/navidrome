...
const DiscoveryEditToolbar = ({ handleSubmitWithRedirect, saving }) => {
...
const DiscoveryEdit = (props) => (
  <Edit title={<DiscoveryTitle />} actions={false} {...props}>
    <DiscoveryEditForm />
  </Edit>
)

export default DiscoveryEdit
