...
const useFullscreenLayoutStyles = makeStyles({
  '@global': {
    'body.musicmatters-player .RaAppBar-root': {
      display: 'none !important',
    },
    'body.musicmatters-player .RaSidebar-root': {
      display: 'none !important',
    },
    'body.musicmatters-player .RaSidebar-fixed': {
      display: 'none !important',
    },
    'body.musicmatters-player .MuiDrawer-root': {
      display: 'none !important',
    },
    'body.musicmatters-player .RaLayout-appFrame': {
      marginTop: 0,
      marginLeft: 0,
    },
    'body.musicmatters-player .RaLayout-contentWithSidebar': {
      margin: 0,
    },
    'body.musicmatters-player .RaLayout-content': {
      padding: 0,
    },
    'body.musicmatters-player #main-content': {
      padding: 0,
    },
  },
})
...
const MusicMattersRetailPlayerDashboard = () => {
  useFullscreenLayoutStyles()
  ...
  useEffect(() => {
    ...
    body.classList.add('musicmatters-player')

    return () => {
      body.classList.remove('musicmatters-player')
    }
  }, [])
...
export default MusicMattersRetailPlayerDashboard
